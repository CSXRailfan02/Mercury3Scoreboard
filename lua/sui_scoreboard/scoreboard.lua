...
function PANEL:Init()
	...
	self.SuiSc:SetText( "sui_scoreboard V2 by Suicidal.Banana, modifications by CSXRailfan02" )
...
function PANEL:PerformLayout()
	...
	self.SuiSc:SetPos( self:GetWide() - 360, self:GetTall() - 15 )
	...
	self.lblTime:SetPos( self:GetWide() - 45*16 - self.lblKills:GetWide()/2, self.PlayerFrame.y - self.lblPing:GetTall() - 3  )
...
function PANEL:ApplySchemeSettings()
	...
	self.lblTime:SetFont( "DefaultSmall" )
	...
	self.lblTime:SetTextColor( Color( 0, 0, 0, 255 ) )
end
